...
class LikeProductAdapter(private val viewModel: LikeViewModel) :
    ListAdapter<Product, LikeProductAdapter.LikeProductViewHolder>(DiffCallback()) {

    class LikeProductViewHolder(private val binding: ListItemProductBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(item: Product, viewModel: LikeViewModel) {
            binding.apply {
                product = item
